...
IF(WIN32)
  ...
  FOREACH(MATVER "7.14" "7.11" "7.10" "7.9" "7.8" "7.7" "7.6" "7.5" "7.4" "8.2")
  ...
  # if not found by normal ways, check specific folders (perhaps registry values are not set)
  IF((NOT DEFINED MATLAB_ROOT)
      OR ("${MATLAB_ROOT}" STREQUAL "")
      OR ("${MATLAB_ROOT}" STREQUAL "/registry"))
	  
	  find_path (MAN_MATLAB_ROOT
		bin/matlab.exe
		PATHS
			"C:\\Program Files\\MatlabR2012a"
			"C:\\Program Files (x86)\\MatlabR2012a"
		DOC "Matlab root directory."
	  )
	  IF(MAN_MATLAB_ROOT)
	    set (MATLAB_ROOT ${MAN_MATLAB_ROOT})
	  ENDIF(MAN_MATLAB_ROOT)
